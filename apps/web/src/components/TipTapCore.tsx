...
export interface TipTapCoreRef {
  getContent: () => string
...
const TipTapCore = forwardRef<TipTapCoreRef, TipTapCoreProps>(({
  ...
  const editor = useEditor({
    extensions: [
      StarterKit.configure({
        // Disable features we don't need for a social media editor
        heading: false,
        blockquote: false,
        bulletList: false,
        orderedList: false,
        ...
        // Keep paragraph, text, hard break, bold, italic
      }),
      Mention.configure({
        HTMLAttributes: {
...
TipTapCore.displayName = 'TipTapCore'
